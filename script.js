...
gsap.to("#Menma", {
  ...
  scrollTrigger: {
    ...
    scrub: true,
    onEnter: () => (changeText("Menma", " Asahi Ashura"), ajusterLargeur("#Menma", "100%")),
    onLeave: () => (changeText("Menma", "Caractère Asahi Ashura"), ajusterLargeur("#Menma", "150%")), 
    onEnterBack: () => changeText("Menma", "Caractère Asahi Ashura"),
    onLeaveBack: () => (changeText("Menma", "Asahi Ashura"), ajusterLargeur("#Menma", "100%")),
  }
});
